# Accessibility Statement – Codex Now vs Then

## Overview
This document outlines the accessibility compliance of the **Codex Now vs Then** Power BI custom visual.
...
## 7. Summary
**Codex Now vs Then** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.